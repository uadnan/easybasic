...
lm.utils.copy( lm.controls.Header.prototype, {
	...
	_createControls: function() {
		...
		if( this.parent.config.isClosable && this.layoutManager.config.settings.showCloseIcon ) {
			...
			new lm.controls.HeaderButton( this, label, 'lm_close', closeStack, 'fa fa-remove');
		}
	},
...
lm.controls.HeaderButton = function( header, label, cssClass, action, icon = '' ) {
	this._header = header;
	this.element = $( '<li class="' + cssClass + '" title="' + label + '"><i class="'+icon+'"></i></li>' );
...
lm.controls.Tab._template = '<li class="lm_tab"><i class="lm_left"></i>' +
							'<span class="lm_title"></span><div class="lm_close_tab"><i class="fa fa-remove"></i></div>' +
							'<i class="lm_right"></i></li>';
